        ...
        (a.prototype = {
            ...
            _generateRating: function () {
                ...
                (n = i.$container = e(document.createElement("div")).insertBefore(l)),
                    ...
                    i._initHighlight(),
                    n.append(l),
                    i.rtl && ((r = Math.max(i.$emptyStars.outerWidth(), i.$filledStars.outerWidth())), i.$emptyStars.width(r)),
                    l.appendTo(a);
            },
            ...
            _renderClear: function () {
                ...
                if (n.showClear) {
                    if (((a = n._getClearClass()), r.length))
                        return t.addCss(r, a), r.attr({ title: n.clearButtonTitle }).html(n.clearButton), void (n.$clear = r);
            ...
            _toggleHover: function (e) {
                ...
                e &&
                    (r.hoverChangeStars &&
                        ((t = r.getWidthFromValue(r.clearValue)), (a = e.val <= r.clearValue ? t + "%" : e.width), r.$filledStars.css("width", a)),
                    r.hoverChangeCaption && ((n = e.val <= r.clearValue ? r.fetchCaption(r.clearValue) : e.caption), n && r._setCaption(n + "")));
            },
            _init: function (t) {
                var a,
                    n = this,
                ...
                return (
                    ...
                    (n.rtl || "rtl" === r.attr("dir")) && ((n.rtl = !0), r.attr("dir", "rtl")),
                    (n.starClicked = !1),
                    (n.clearClicked = !1),
                    n._initSlider(t),
                    n._checkDisabled(),
                    n.displayOnly && ((n.inactive = !0), (n.showClear = !1), (n.showcaption = !1)),
                    n._generateRating(),
                    n._initEvents(),
                    n._listen(),
            ...
            _initEvents: function () {
                ...
                e.events = {
                    ...
                    starMouseLeave: function (t) {
                        ...
                        e.events._noMouseAction(t) ||
                            e.starClicked ||
                            ((a = e.cache), e._toggleHover(a), e.$element.trigger("rating.hoverleave", ["stars"]));
                    },
                    ...
                    clearMouseLeave: function (t) {
                        ...
                        e.events._noMouseAction(t) ||
                            e.clearClicked ||
                            !e.hoverOnClear ||
                            ((a = e.cache), e._toggleHover(a), e.$element.trigger("rating.hoverleave", ["clear"]));
                    },
            ...
            _listen: function () {
                var a = this,
                    ...
                    s = a.events;
                return (
                    t.handler(i, "touchstart touchmove touchend", e.proxy(s.initTouch, a)),
            ...
            getWidthFromValue: function (e) {
                ...
                return !e || r >= e || r === i
                    ? 0
                    : ((a = l.outerWidth()), (t = a ? l.width() / a : 1), e >= i ? 100 : ((e - r) * t * 100) / (i - r));
            },
